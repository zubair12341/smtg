...
@section('title', 'Select Accommodation')
@section('content')
    ...
    <div class="inner-baner-container" style="background-image: url({{ asset('assets/images/inner-banner.jpg') }});">
       <div class="container">
          <div class="inner-banner-content">
             <h1 class="inner-title">Select Accommodation</h1>
          </div>
       </div>
    </div>
  ...
  <div class="trip-search-section shape-search-section">
    ...
    <div class="container">
       ...
       <div class="trip-search-inner white-bg d-flex">
        <input type="hidden" name="place" placeholder="No.of People" @if(isset($_GET['place'])&&$_GET['place']!='') value="{{$_GET['place']}}" @endif>
 ...
 <section class="about-section about-page-section" id="search_data">
    <div class="container">
        @if(isset($_GET['place'])&&$_GET['place']!='') 
            <div class="row">
                <div class="col-12">
                    <h3>Hotels Found at {{$_GET['place']}}</h3>
                </div>
            </div>
        @endif
        <div class="row">
...
const placesPromise = searchPlaces(apiKey, "rent car services at "+userQuery);
